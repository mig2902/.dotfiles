...
(global-set-key (kbd "C-c v") 'visual-line-mode)
 (add-hook 'elfeed-show-mode-hook 'turn-on-visual-line-mode)
...
;; eww como navegador predeterminado
...
(setq elfeed-feeds
	...
	("https://manjaro.org/news/" tech manjaro linux)
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "#0E132F" :foreground "#e0afdb" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 113 :width normal :foundry "PfEd" :family "Fantasque Sans Mono"))))
 '(border ((t nil)))
 '(cursor ((t (:background "#e0afdb"))))
 ...
 '(fringe ((t (:background "#0E132F" :foreground "#D8DEE9"))))
 '(highlight ((t (:background "#6756D2" :foreground "#e1e1e0"))))
 '(hl-line ((t (:inherit nil :background "plum4" :foreground "black"))))
 '(line-number-current-line ((t (:inherit \#D8DEE9))))
 '(mode-line ((t (:background "#0E132F" :foreground "#e0afdb"))))
 ...
 '(region ((t (:background "#e0afdb" :foreground "#0E132F"))))
