...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "#151930" :foreground "#ebc9dd" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 113 :width normal :foundry "PfEd" :family "Fantasque Sans Mono"))))
 '(cursor ((t (:background "#ebc9dd"))))
 ...
 '(fringe ((t (:background "#151930" :foreground "#D8DEE9"))))
 ...
 '(mode-line ((t (:background "#151930" :foreground "#ebc9dd"))))
 '(mode-line-inactive ((t (:background "#151930" :foreground "#D8DEE9"))))
