...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "#090C0F" :foreground "#c9c5bb" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 113 :width normal :foundry "PfEd" :family "Fantasque Sans Mono"))))
 '(cursor ((t (:background "#cadde7"))))
 ...
 '(fringe ((t (:background "#090C0F" :foreground "#D8DEE9"))))
 ...
 '(mode-line ((t (:background "#090C0F" :foreground "#c9c5bb"))))
 ...
 '(region ((t (:background "#cadde7" :foreground "#0E132F"))))
