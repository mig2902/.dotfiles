...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "#120f1c" :foreground "#e0aca2" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 113 :width normal :foundry "PfEd" :family "Fantasque Sans Mono"))))
 '(cursor ((t (:background "#A05767"))))
 ...
 '(fringe ((t (:background "#120f1c" :foreground "#D8DEE9"))))
 ...
 '(mode-line ((t (:background "#120f1c" :foreground "#e0aca2"))))
 ...
 '(region ((t (:background "#A05767" :foreground "#0E132F"))))
